...
public class SubscribeRecyAdapter extends RecyclerView.Adapter<SubscribeRecyAdapter.ViewHolder> {
    ...
    private List<SubscribeListsModel> mDatas;
    private Context context;

    public SubscribeRecyAdapter(Context context, List<SubscribeListsModel> datats) {
    ...
    public void setData(List<SubscribeListsModel> mDatas) {
        if (mDatas != null) {
            this.mDatas = mDatas;
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int i) {
        ...
        ImageLoader.getInstance().displayImage(mDatas.get(i).getSmallPicUrl(),
                viewHolder.iv_icon);
        viewHolder.tv_name.setText(mDatas.get(i).getPoliticsAreaName());
