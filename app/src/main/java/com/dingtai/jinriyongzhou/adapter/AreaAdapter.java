...
public class AreaAdapter extends BaseAdapter {
    ...
    public AreaAdapter(Context context, List<PoliticsAreaModel> indexModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // tv_name.setText("更多");
        // } else {
        PoliticsAreaModel model = indexModels.get(position);
        ImageLoader.getInstance().displayImage(model.getAreaSmallPicUrl(), iv_icon,
                option);
