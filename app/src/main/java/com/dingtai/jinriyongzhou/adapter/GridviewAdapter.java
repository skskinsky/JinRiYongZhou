...
public class GridviewAdapter extends BaseAdapter {
    ...
    public GridviewAdapter(Context context, List<IndexModel> indexModels) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        // tv_name.setText("更多");
        // } else {
        IndexModel model = indexModels.get(position);
        ImageLoader.getInstance().displayImage(model.getModuleLogo(), iv_icon,
                option);
        tv_name.setText(model.getModuleName());
        // }
        return convertView;
    }
